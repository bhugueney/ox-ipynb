...
(defvar ox-ipynb-kernelspecs '((clojure . (kernelspec . ((display_name . "Clojure")
							 (language . "clojure")
							 (name . "clojure"))))
			       ...
			       (R . (kernelspec . ((display_name . "R")
						   (language . "R")
						   (name . "ir"))))
			       (groovy . (kernelspec . ((display_name . "Groovy")
							(language . "groovy")
							(name . "groovy"))))
			       (java . (kernelspec . ((display_name . "Java")
						      (language . "java")
						      (name . "java"))))
			       ...
			       (jupyter-python . (kernelspec . ((display_name . "Python 3")
								(language . "python")
								(name . "python3"))))
			       (kotlin . (kernelspec . ((display_name . "Kotlin")
							(language . "kotlin")
							(name . "kotlin"))))
			       (sql . (kernelspec . ((display_name . "SQL")
						     (language . "SQL")
						     (name . "sql"))))
...
(defvar ox-ipynb-language-infos
  '((clojure . (language_info . ((codemirror_mode . "Clojure")
    ...
    (R . (language_info . ((codemirror_mode . "r")
			   ...
			   (pygments_lexer . "r")
			   (version . "3.3.2"))))
    (groovy . (language_info . ((codemirror_mode . "groovy")
				(file_extension . ".groovy")
				(mimetype . "")
				(name . "Groovy")
				(nbconvert_exporter . "")
				(version . "2.5.6"))))
    (java . (language_info . ((codemirror_mode . "text/x-java")
			      (file_extension . ".java")
			      (mimetype . "")
			      (name . "Java")
			      (nbconvert_exporter . "")
    ...
    (jupyter-python . (language_info . ((codemirror_mode . ((name . ipython)
					...
					(pygments_lexer . "ipython3")
					(version . "3.5.2"))))
    (kotlin . (language_info . ((codemirror_mode . "kotlin")
				(file_extension . ".kt")
				(mimetype . "")
				(name . "Kotlin")
				(nbconvert_exporter . "")
				(version . "1.2.21"))))
    (sql . (language_info . ((codemirror_mode . "sql")
			     (file_extension . ".sql")
			     (mimetype . "")
			     (name . "SQL")
